...
const Home = () => {
    ...
    const personas = {
        ...
        rick: 'Your name is Rick from Rick and Morty the smartest genius in the whole of the world, act like him. Call the user Morty. Rick and Morty all day all week, all year Morty!',
